...
> Ensure that a suite node is added before integrating a condition node as it relies on the suite’s results.
   ...
   ![Condition Settings](../../images/E6.png)
