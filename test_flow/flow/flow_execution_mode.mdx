...
4. **Completion Status**:
   ...
   ![Completion Status](../../images/MODE5.png)
...
1. **Selecting Mode of Execution**:
   ...
   ![Parallel Execution](../../images/MODE6.png)
...
2. **Observe Multiple Nodes**:
   ...
   ![Multiple Nodes Progress](../../images/MODE7.png)
